        ...
        <div class="row justify-content-md-center">
            <div class="col-lg-10">
                <div class="section-content bg-white p-5 shadow">
                    ...
                    <?php } else { ?>
                        <form method="post" name="contact-us" action="contactmessage.php">
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    <textarea name="message" id="message" rows="10" class="form-control" placeholder="Send your feedback"></textarea>
