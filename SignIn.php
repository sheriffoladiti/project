...
<html lang="en">
    ...
    <!-- Reservation Section -->
    <section id="gtco-reservation" class="bg-fixed bg-white section-padding overlay" style="background-image: url(img/signin-bg.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
...
<body>
  ...
  <form method="post" action="signin.php">
  	...
  	<div class="input-group">
  		<button class="btn btn-primary btn-shadow btn-lg" type="submit" class="btn" name="login_user">Login</button>
